    ...
    },
    {
      ...
      content: {
        ...
        body:
          ...
          "・広告（PR）のリンク\n" +
          "　押したときに外部サイトへ移動するだけで、旅程やプロフィールを広告主へ渡すことはありません。広告を配信するための追跡もしていません。",
      },
    },
    {
      key: "ads",
      ...
      content: {
        title: "広告について",
        body:
          "無料でお使いいただくため、一部の画面に「PR」と表示したリンクを出しています。\n\n" +
          "・持ち物リスト\n" +
          "　まだチェックが付いていない持ち物に、旅行用品を探すリンクを添えています。チェックを付けると消えます。\n\n" +
          "・行き先リストの「宿泊先」\n" +
          "　泊まりの日程では、まだ宿が決まっていない泊に「宿を探す」を出しています。宿を登録するか、「この泊は宿を取らない」を選ぶと消えます。\n\n" +
          "当日の画面と地図には広告を出しません。旅行中に見る画面なので、必要なことだけを出します。\n\n" +
          "リンク先で購入・予約されると、当サービスに収益が入ることがあります。金額が上乗せされることはありません。",
      },
    },
    {
      key: "support",
  ...
  return (
    <View className="flex-1 bg-kinari" style={{ paddingTop: insets.top }}>
      ...
      <ScrollView className="flex-1 px-[26px]" contentContainerStyle={{ paddingTop: 16, paddingBottom: 90 }}>
        ...
        <Text className="mt-2 text-center font-gothic-400 text-[11px] text-muted-light">旅ナビ / TABI-NAVI</Text>
      </ScrollView>
